...
const AdminHeader = () => {
  ...
  const handleLogout = () => {
    ...
    localStorage.removeItem("userID"); // Dispatch the signOut action
      ...
      <div className="w-full border flex items-center shadow fixed top-0 z-[3] justify-between bg-white h-[60px]">
        ...
        <div className="flex items-center gap-2">
          <div className="flex items-center cursor-pointer group relative">
            <div
              className="absolute top-[100%] right-[5%] rounded-md bg-white hidden group-hover:flex flex-col w-[180px]  shadow-lg border z-[3]"
              style={{ zIndex: "100" }}
            >
              <div className="text-center font-semibold md:hidden block pt-2 text-lg   text-[#5E81F4]">
                {user.name}
              </div>

              <div className="w-[75%] mx-auto mt-3">
                {/* <button className="w-full bg-[#EDEDED] py-1 border border-black rounded-md font-semibold" >{userData.isActive?}</button> */}
                <button
                  className={`w-full py-1 border border-black rounded-md font-semibold ${
              ...
              <div className="w-[75%] mx-auto mt-3">
                <button
                  className="w-full bg-[#5E81F4] text-white py-1 rounded-md font-semibold mb-2"
            ...
            <div className="flex-col ps-2 mx-2 hidden md:flex">
              <div className="font-semibold flex items-center">
                <div className="font-semibold text-[#5E81F4] hidden md:block text-1xl">
                  {user.name}
                </div>
              </div>
            </div>
            ...
            <div className="w-full flex items-center mb-4 justify-between">
              <div className="flex mt-2 items-center">
                <img
                  ...
                  width={80}
                />
                <div className=" font-semibold text-[#5E81F4]   text-1xl">
                  {user.name}
                </div>
              </div>
              <MdOutlineClose
