      ...
      <div className="w-full flex flex-col">
        <div className="w-full grid grid-cols-12 gap-3">
          ...
          <div className="col-span-3   md:col-span-4 flex justify-center mt-3 items-center">
            <button className="w-full flex justify-center items-center rounded-md h-[50px] px-2 text-white text-lg font-semibold  bg-[#5E81F4]"><span className="hidden md:block">Add Vehicle</span><MdAddCard className="" /></button>
          </div>
