...
const Sarathi = () => {
  ...
  const [dob, setDob] = useState(null); // Changed to null to work with DatePicker
      ...
      const response = await axios.post(
        "https://fastagtracking.com/customulip/ulipApi",
        {
          ...
          parameters: {
            ...
            dob: dob ? dob.toISOString().split("T")[0] : "", // Format the date for API
          },
        },
        {
          ...
          <div className="w-full flex flex-col mt-3">
            ...
            <div className="mt-3 w-full bg-white rounded-md h-[450px] overflow-y-scroll flex flex-col ps-3">
              {loading ? (
                  ...
                  <div className="flex flex-col ps-2">
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <div className="text-zinc-500 font-semibold">
                          {vehicleData.licenseInformation.issuedDate.replace(
                            /\*/g,
                            ""
                          )}
                        </div>
                      ...
                      <div>
                        ...
                        <div className="text-zinc-500 font-semibold">
                          {vehicleData.licenseInformation.licenseValidity.replace(
                            /\*/g,
                            ""
                          )}
                        </div>
                      ...
                      <div>
                        <div className="text-lg font-bold">License Status</div>
                        <div className="text-zinc-500 font-semibold">
                          {vehicleData.licenseInformation.status}
                        </div>
                      </div>
                ...
                <div className="flex justify-center items-center h-full">
                  Enter a DL Number and DOB to search.
                </div>
              )}
            </div>
          </div>
        </div>
        <div className="md:col-span-8 min-h-[700px] h-[500px] max-h-[500px] mt-[10px] ms-[12px] md:mt-[50px] md:ms-[20px] rounded-2xl flex overflow-hidden">
          <Map />
        </div>
      </div>
    </>
