...
const VahanId = () => {
  ...
  return (
    <>
      <div className="w-full grid grid-cols-1 mt-[80px] md:grid-cols-12 gap-5  md:gap-2  md:pt-0 pt-3  md:pb-0 pb-2">
        ...
        <div className="md:w-[90%] w-[100%] ms-1 hidden  md:block mx-auto min-h-[620px]  z-[-0]  md:col-span-8  flex justify-center items-center">
          <Map tollData={[]} />
        </div>
      </div>
      {/* chils */}
